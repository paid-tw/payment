...
| API              | Doc id   | Endpoint                  | Status | Notes                                                                                                                                                                                                       |
| ---------------- | -------- | ------------------------- | ------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 建立委託         | NPA-B05  | `/MPG/period`             | ✅     | Version 1.5. Hosted-page form (`MerchantID_` + `PostData_`, **no TradeSha**). Schedule validated locally (PeriodType/PeriodPoint ranges, PeriodFirstdate only with D+startType 3, PeriodTimes 1–99 or `NE`) |
